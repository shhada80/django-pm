...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # يجب أن يكون هنا مباشرة
...
# قاعدة البيانات التي ستعامل معها المشروع
# DATABASES = {
#     "default": {
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "django-pm"),
